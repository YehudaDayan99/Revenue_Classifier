...
# ============================================================================
# SOUP CACHE - Avoid redundant HTML parsing (10-K files are 5-10MB, slow to parse)
# ============================================================================
_SOUP_CACHE: Dict[str, BeautifulSoup] = {}


def _get_cached_soup(html_path: Path) -> BeautifulSoup:
    """Get a cached BeautifulSoup object for an HTML file.
    
    Parsing a 5-10MB 10-K file takes 0.5-1.5 seconds. This cache ensures
    we only parse each file once per process.
    """
...
def clear_soup_cache() -> None:
    """Clear the soup cache (call between pipeline runs if needed)."""
    _SOUP_CACHE.clear()
