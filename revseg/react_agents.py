...
# DEPRECATED: choose_item_col and validate_extracted_labels were previously defined
# inline here. They are now provided by revseg.skills.table_extraction.validate_item_col
# (imported above). Old implementations removed to avoid duplication.
